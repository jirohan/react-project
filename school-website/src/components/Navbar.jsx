    ...
    <div className='w-full h-[90px] bg-white'>
        <div className='max-w-[1240px] h-full mx-auto px-4 flex justify-between items-center cursor-pointer bg-black text-white md:bg-white md:text-black sm:bg-black sm:text-white'>
            ...
            <div onClick={handleNav} className='block md:hidden'>
                {nav ? <AiOutlineClose size={30} className='md:text-black text-white' /> :<div className='flex items-center'> <p>MENU</p><AiOutlineMenu size={30} className='md:text-black text-white' /></div> }
            </div>
