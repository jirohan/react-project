        ...
        <div className='w-full md:w-[80%] h-full mx-auto px-4 flex justify-between items-center cursor-pointer bg-orange-500 text-white'>
            ...
            <div className={nav ? 'w-[80%] h-[50%] absolute top-[90px] left-0 justify-center bg-black/90 text-white' : 'absolute left-[-100%]'}>
              <ul>
                ...
                <li>Teachers</li>
                <li>Contact</li>
                <button className='p-2 my-2 mx-2 rounded-xl w-[15%] bg-white text-black'>Call Now</button>
              </ul>
            </div>
        </div>
    </div>
